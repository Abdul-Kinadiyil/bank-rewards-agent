...
```sh
curl --location "https://$APIGEE_HOST/v1/crm/rewards" \
--header "Content-Type: application/json" \
--header "x-apikey: $APIKEY"
```

### To access Bank Rewards Members API

#### Get Member:

```sh
curl --location "https://$APIGEE_HOST/v1/crm/members/31432" \
--header "Content-Type: application/json" \
--header "x-apikey: $APIKEY"
```
...
```sh
curl --location "https://$APIGEE_HOST/v1/crm/members" \
--header "Content-Type: application/json" \
--header "x-apikey: $APIKEY"
```
...
```sh
curl --location --request DELETE "https://$APIGEE_HOST/v1/crm/members/12345" \
--header "Content-Type: application/json" \
--header "x-apikey: $APIKEY"
```
